...
if __name__ == '__main__':
    mik = Student("Diana", "Albertovna", "Diulberova", Path('lessons.csv'))
    print(mik)
    ...
    mik.new_estimate("астрономия", 18, "test")
    mik.new_estimate("астрономия", 74, "test")
    mik.new_estimate("химия", 39, "test")
